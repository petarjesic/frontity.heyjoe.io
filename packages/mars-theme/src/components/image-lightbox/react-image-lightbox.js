      ...
      >
        ...
        >
          ...
          <div className="ril-actions">
            <span style={{marginLeft: '5px', marginRight: '5px'}} onClick={this.props.onRateClick.bind(null, 'Yes')} ><YesIcon width={'64'} height={'64'}/></span>
            <span style={{marginLeft: '5px', marginRight: '5px'}} onClick={this.props.onRateClick.bind(null, 'No')} ><NoIcon width={'64'} height={'64'}/></span>
            <span style={{marginLeft: '5px', marginRight: '5px'}} onClick={this.props.onRateClick.bind(null, 'Maybe')} ><MaybeIcon width={'64'} height={'64'}/></span>
          </div>
        </div>
      </Modal>
    );
